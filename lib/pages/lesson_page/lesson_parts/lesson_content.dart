...
class LessonContent extends StatefulWidget {
  ...
  const LessonContent({super.key, this.contentJSON});
...
class _LessonContentState extends State<LessonContent> {
  ...
  void initState() {
    super.initState();
    // The way json is generated may be changed whatever you want
    toJson(ListView(children: [
              Column(children: [
                const Row(
                  children: [
                    Flexible(
  ...
  void toJson(Widget root){
    //TODO add json generating code
  }

  Widget fromJson(String json) {
    //TODO add json reading code
    return Container();
  }
