...
class _LessonContentState extends State<LessonContent> {
  ...
  List<GlobalKey> widgetsID = List.generate(9, (index) => GlobalKey());
  ...
  void scrollToWidget(GlobalKey widgetKey) {
    ...
    double appBarHeight = (Scaffold.of(context).appBarMaxHeight ?? 0.0) ;//- 50;// MediaQuery.of(context).padding.top;
    double y = position.dy + appBarHeight + _controller.position.pixels;
                        ...
                        Padding(
                          ...
                          child: ElevatedButton(
                            onPressed: (){
                              setState(() {
                                blockIndex++;
                                _buttonStates[blockIndex] = true;
                              });
                              scrollToWidget(widgetsID[1]);
                            },
